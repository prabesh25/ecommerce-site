...
//   const ChatbotLogo = () => (
//     <svg className="w-8 h-8 bg-white p-1 rounded-full fill-current text-purple-600" 
...
//                 placeholder="Message..."
//                 className="w-full p-2 pr-20 border rounded-2xl resize-none focus:outline-none focus:ring-2 focus:ring-purple-500"
//                 rows="1"
//               />
...
//                   className={`p-2 rounded-full hover:bg-gray-100 ${isListening ? 'text-red-500' : 'text-gray-600'}`}
//                 >
